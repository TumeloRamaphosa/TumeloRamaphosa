...
- NOTE: This skill requires outbound network access to YouTube. In sandboxed/remote
  environments where YouTube domains are blocked by the network policy, run the
